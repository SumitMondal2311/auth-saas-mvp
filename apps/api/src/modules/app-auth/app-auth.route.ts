...
export const appAuthRouter: Router = Router();

// Signup Route Group //
appAuthRouter.post("/signup", prepareInputMiddleware, handleAsync(signupController));
appAuthRouter
...
// Login Route Group //
appAuthRouter.post("/login", prepareInputMiddleware, handleAsync(loginController));
appAuthRouter
...
appAuthRouter.post("/refresh", handleAsync(refreshController));
appAuthRouter.post("/logout", handleAsync(authMiddleware), handleAsync(logoutController));
